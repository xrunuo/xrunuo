...
namespace Server.Gumps
{
	public class KRGumpLabel : GumpEntry
	{
		...
		{
			return $"{{ kr_text {m_X} {m_Y} {m_Width} {m_Height} {m_Number} {( m_Background ? 1 : 0 )} {( m_Scrollbar ? 1 : 0 )} }}";
		}

		private static readonly byte[] m_LayoutName = Gump.StringToBuffer( "kr_text" );
