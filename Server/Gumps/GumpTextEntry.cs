...
namespace Server.Gumps
{
	public class GumpTextEntry : GumpEntry
	{
		...
		private readonly int m_InitialTextID;
		...
		{
			return $"{{ textentry {m_X} {m_Y} {m_Width} {m_Height} {m_Hue} {m_EntryID} {( m_InitialText == null ? m_InitialTextID : Parent.Intern( m_InitialText ) )} }}";
		}
