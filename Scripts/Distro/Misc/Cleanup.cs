...
namespace Server.Misc
{
	public static class Cleanup
	{
		...
		public static void ConvertHair( this Mobile m )
		{
			Item hair;

			if ( ( hair = m.FindItemOnLayer( Layer.Hair ) ) != null )
			{
				m.HairItemID = hair.ItemID;
				m.HairHue = hair.Hue;
				hair.Delete();
			}

			if ( ( hair = m.FindItemOnLayer( Layer.FacialHair ) ) != null )
			{
				m.FacialHairItemID = hair.ItemID;
				m.FacialHairHue = hair.Hue;
				hair.Delete();
			}
		}
