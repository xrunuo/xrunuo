...
namespace Server.Items
{
	...
	public class HolidayTreeChoiceGump : Gump
	{
			...
			: base( 200, 200 )
		{
			...
			AddBackground( 10, 10, 180, 160, 3000 );
			...
			AddButton( 20, 95, 4005, 4007, 3, GumpButtonType.Reply, 0 );
			AddHtmlLocalized( 55, 95, 145, 25, 1095240, false, false ); // Classic (Bare)

			AddButton( 20, 125, 4005, 4007, 4, GumpButtonType.Reply, 0 );
			AddHtmlLocalized( 55, 125, 145, 25, 1095241, false, false ); // Modern (Bare)
