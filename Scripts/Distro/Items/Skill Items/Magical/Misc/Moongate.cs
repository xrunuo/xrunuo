...
namespace Server.Items
{
	...
	public class Moongate : Item
	{
		...
		public override bool ForceShowProperties { get { return this.Name != null; } }
		...
		public virtual void UseGate( Mobile m )
		{
			...
			else if ( ( m.Murderer && m_TargetMap != Map.Felucca ) || ( houseRegion != null && !houseRegion.House.HasAccess( m ) ) )
			{
	...
	{
		public override int TypeID { get { return 0x232D; } }
