			...
			if ( m_Held > 0 )
			{
				if ( m_Unknown )
				{
					switch ( m_Type )
					{
						...
						case PotionEffect.RefreshGreater: number = 1041616; break; // A keg of red liquid.
						...
						case PotionEffect.ParasiticPoison: number = 1080067; break; // A Keg of Murky Liquid.
						case PotionEffect.DarkglowPoison: number = 1080068; break; // A Keg of Baneful Liquid.
					}
				}
				else
				{
					switch ( m_Type )
					{
						...
						case PotionEffect.Invisibility: number = 1080071; break; // A keg of Invisibility potions
						case PotionEffect.ParasiticPoison: number = 1080069; break; // A keg of Parasitic Poison potions
						case PotionEffect.DarkglowPoison: number = 1080070; break; // A keg of Darkglow Poison potions
