...
namespace Server.Items
{
	...
	{
		public override int TypeID { get { return 0x191; } }
		...
		private void RenderCategories()
		{
			...
			{
				AddButton( 30, 85 + ( i * 25 ), 5224, 5224, 1 + i, GumpButtonType.Page, 1 + i );
			...
			for ( int i = 0; i < groups.Length; ++i )
			{
				...
				{
					AddLabelIntern( 278, 90 + ( j * 25 ), hues[j], 0 );
					AddRadio( 260, 90 + ( j * 25 ), 210, 211, false, hues[j]/*GetRadioID( i, j )*/ );
				}
			}
		}
			...
			: base( 50, 50 )
		{
			...
			if ( definition.DefaultSupported )
				Intern( "DEFAULT" );
				...
				case 1: // Okay
					{
						...
						if ( switches.Length > 0 )
						{
							...
							m_Callback( m_From, m_State, index );
