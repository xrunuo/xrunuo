...
namespace Server.Items
{
	...
	public abstract class BasePlayerBB : Item, ISecurable
	{
		...
		public ArrayList Messages { get { return m_Messages; } }

		public PlayerBBMessage Greeting { get { return m_Greeting; } set { m_Greeting = value; } }
	...
	public class PlayerBBMessage
	{
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public Mobile Poster { get { return m_Poster; } set { m_Poster = value; } }
				...
				case 3: // Post greeting
					{
						if ( house.IsOwner( from ) )
						{
							// Enter new greeting (this will always be the first post):
