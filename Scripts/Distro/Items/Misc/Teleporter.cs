...
namespace Server.Items
{
	public class Teleporter : Item
	{
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public bool Creatures { get { return m_Creatures; } set { m_Creatures = value; } }

		public override int LabelNumber { get { return 1026095; } } // teleporter

		public virtual bool ShowProperties { get { return true; } }
		...
		public override bool OnMoveOver( Mobile m )
		{
			if ( m_Active )
			{
				...
				if ( m.Account is Account && ( (Account) m.Account ).Trial )
				{
					...
					else if ( SpellHelper.IsFeluccaT2A( m_MapDest, m_PointDest ) )
					{
						m.SendMessage( "Trial account players may not enter the Lost Lands." );
						return true;
					}
				}
