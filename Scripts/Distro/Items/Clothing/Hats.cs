...
namespace Server.Items
{
	public abstract class BaseHat : BaseClothing, IShipwreckedItem
	{
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public override int TimesImbued
		{
		...
		public override ImbuingFlag ImbuingFlags { get { return ImbuingFlag.Armor; } }
		public override bool IsSpecialMaterial { get { return false; } }
		public override int MaxIntensity { get { return 500; } }
		public override bool CanImbue { get { return ArtifactRarity == 0; } }
		#endregion
	}
	...
	public class SavageMask : BaseHat
	{
		...
		public override bool CanEquip( Mobile m )
		{
			...
			if ( AnimalForm.UnderTransformation( m ) )
			{
