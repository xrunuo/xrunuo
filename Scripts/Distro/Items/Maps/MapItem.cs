...
namespace Server.Items
{
	...
	{
		public virtual Map DisplayMap { get { return Map.Trammel; } }
		...
		public bool Protected { get { return m_Protected; } set { m_Protected = value; } }
		...
		public List<Point2D> Pins { get { return m_Pins; } }
		...
		public void SetDisplay( int x1, int y1, int x2, int y2, int w, int h )
		{
			...
			EnsureInBounds( DisplayMap, ref x1, ref x2, ref y1, ref y2 );

			Bounds = new Rectangle2D( x1, y1, x2 - x1, y2 - y1 );
		}

		public static void EnsureInBounds( Map map, ref int x1, ref int x2, ref int y1, ref int y2 )
		{
			if ( x1 < 0 )
				x1 = 0;
		...
		public virtual void DisplayTo( Mobile from )
		{
			...
			{
				from.Send( new MapAddPin( this, pin ) );
			}
