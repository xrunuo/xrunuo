...
namespace Server.Engines.Mahjong
{
	public class MahjongTile
	{
		...
		public MahjongPieceDim Dimensions { get { return GetDimensions( m_Position, m_Direction ); } }

		public bool IsMovable { get { return m_Game.GetStackLevel( Dimensions ) <= m_StackLevel; } }
