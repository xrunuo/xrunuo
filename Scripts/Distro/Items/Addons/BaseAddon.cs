...
namespace Server.Items
{
	...
	public abstract class BaseAddon : Item, IChopable, IAddon
	{
		...
		Item IAddon.Deed { get { return this.Deed; } }

		public ArrayList AddonComponents { get { return m_Components; } }
		...
		public bool CheckHouse( Mobile from, Point3D p, Map map, int height, ArrayList list )
		{
			...
			IHouse house = HousingHelper.FindHouseAt( p, map, height );
