...
namespace Server.Items
{
	public class StatCapScroll : Item
	{
		...
		public override LocalizedText GetNameProperty()
		{
			if ( m_Value == 230 )
			{
				return new LocalizedText( 1049463, "#1049476" ); // a wonderous scroll of ~1_type~ (+5 Maximum Stats)
			}
			else if ( m_Value == 235 )
			{
				return new LocalizedText( 1049464, "#1049476" ); // an exalted scroll of ~1_type~ (+10 Maximum Stats)
			}
			else if ( m_Value == 240 )
			{
				return new LocalizedText( 1049465, "#1049476" ); // a mythical scroll of ~1_type~ (+15 Maximum Stats)
			}
			else if ( m_Value == 245 )
			{
				return new LocalizedText( 1049466, "#1049476" ); // a legendary scroll of ~1_type~ (+20 Maximum Stats)
			}
			else if ( m_Value == 250 )
			{
				return new LocalizedText( 1049467, "#1049476" ); // an ultimate scroll of ~1_type~ (+25 Maximum Stats)
			}
			else
			{
				return new LocalizedText( "a scroll of power ({0}{1} Maximum Stats)", ( m_Value - 225 ) >= 0 ? "+" : "", m_Value - 225 );
			}
		}
