...
namespace Server.Items
{
	public class BraceletOfBinding : BaseBracelet, TranslocationItem
	{
		...
		{
			return new LocalizedText( 1054000, m_Charges.ToString() + ( m_Inscription.Length == 0 ? "\t " : " :\t" + m_Inscription ) ); // a bracelet of binding : ~1_val~ ~2_val~
		}
		...
		private bool CheckUse( Mobile from, bool successMessage )
		{
			...
			else if ( boundRoot == null || boundRoot.Client == null || boundRoot.FindItemOnLayer( Layer.Bracelet ) != bound )
			{
		...
		private class InscribePrompt : Prompt
		{
			...
			public override int MessageCliloc { get { return 1054009; } }
