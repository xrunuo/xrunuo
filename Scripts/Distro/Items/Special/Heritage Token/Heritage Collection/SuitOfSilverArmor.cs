...
namespace Server.Items
{
	...
	public class SuitOfSilverArmorComponent : AddonComponent
	{
		...
		public SuitOfSilverArmorComponent( int itemID )
			: base( itemID )
		{
		}
	...
	public class SuitOfSilverArmorAddon : BaseAddon
	{
		...
		[Constructable]
		public SuitOfSilverArmorAddon( bool east )
			: base()
		{
			if ( east )
			{
				AddComponent( new SuitOfSilverArmorComponent( 0x3D87 ), 0, 0, 0 );
			}
			else
			{
				AddComponent( new SuitOfSilverArmorComponent( 0x3D86 ), 0, 0, 0 );
			}
		}
	...
	public class SuitOfSilverArmorDeed : BaseAddonDeed
	{
		...
		{
			private SuitOfSilverArmorDeed m_Deed;

			public InternalGump( SuitOfSilverArmorDeed deed )
				: base( 60, 36 )
			{
				m_Deed = deed;
				...
				AddHtml( 14, 12, 273, 20, @"<CENTER><basefont color=#FFFFFF>Select your Suit Of Silver Armor position</basefont></CENTER>", false, false ); // Please select your fish net position
