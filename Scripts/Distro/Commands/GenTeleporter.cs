...
namespace Server
{
	public class GenTeleporter
	{
		...
		{
			CommandSystem.Register( "TelGen", AccessLevel.Developer, new CommandEventHandler( GenTeleporter_OnCommand ) );
			CommandSystem.Register( "SATelGen", AccessLevel.Developer, new CommandEventHandler( SAGenTeleporter_OnCommand ) );
		}
		...
		[Usage( "SATelGen" )]
		[Description( "Generates Stygian Abyss Expansion Teleporters." )]
		public static void SAGenTeleporter_OnCommand( CommandEventArgs e )
		{
			e.Mobile.SendMessage( "Generating SA teleporters, please wait." );

			new TeleportersCreator().CreateTeleportersTerMur();

			e.Mobile.SendMessage( "SA Teleporter generating complete." );
		}
		...
		public class TeleportersCreator
		{
			...
			public void CreateTeleporter( int xLoc, int yLoc, int zLoc, int xDest, int yDest, int zDest, Map map_from, Map map_to, bool back )
			{
				CreateTeleporter( new Point3D( xLoc, yLoc, zLoc ), new Point3D( xDest, yDest, zDest ), map_from, map_to, back );
			}
			...
			public void CreateLocalizedTeleporter( int xLoc, int yLoc, int zLoc, int xDest, int yDest, int zDest, Map map_from, Map map_to, int label_number )
			{
				LocalizedTeleporter ltp = new LocalizedTeleporter( new Point3D( xDest, yDest, zDest ), map_to, label_number );

				m_Count++;

				ltp.MoveToWorld( new Point3D( xLoc, yLoc, zLoc ), map_from );
			}
			...
			public void CreateTeleportersMap( Map map )
			{
				...
				// Britain
				CreateLocalizedTeleporter( 1414, 1630, 50, 1414, 1626, 23, map, map, 1016035 ); // A teleporter to the ground.
				CreateLocalizedTeleporter( 1424, 1691, 20, 1420, 1695, 0, map, map, 1016386 ); // This tile will teleport you to the ground.
				CreateLocalizedTeleporter( 1493, 1624, 60, 1491, 1629, 16, map, map, 1016035 ); // A teleporter to the ground.
				CreateLocalizedTeleporter( 1519, 1454, 35, 1521, 1457, 15, map, map, 1016035 ); // A teleporter to the ground.

				// Moonglow
				CreateLocalizedTeleporter( 4469, 1173, 20, 4465, 1177, 0, map, map, 1016386 ); // This tile will teleport you to the ground.
				CreateLocalizedTeleporter( 4454, 1086, 20, 4454, 1086, 0, map, map, 1016035 ); // A teleporter to the ground.

				// Serpent's Hold
				CreateLocalizedTeleporter( 2968, 3382, 55, 2963, 3386, 15, map, map, 1016035 ); // A teleporter to the ground.
			}
			...
			public void CreateTeleportersMap2( Map map )
			{
				...
				*/
				...
				// Misc teleporters
				CreateTeleporter( 857, 903, -33, 912, 919, -27, map, false );
			}
			...
			public void CreateTeleportersMap3( Map map )
			{
				...
				// Fan Dancer Dungeon Entrance
				CreateTeleporter( 64, 336, 11, 986, 197, 16, map, Map.Tokuno, false );
				CreateTeleporter( 64, 337, 11, 986, 197, 16, map, Map.Tokuno, false );
				CreateTeleporter( 64, 338, 11, 986, 197, 16, map, Map.Tokuno, false );
				CreateTeleporter( 64, 339, 11, 986, 197, 16, map, Map.Tokuno, false );

				// Fan Dancer Level 1
				CreateTeleporter( 67, 351, -7, 61, 525, 6, map, false );
				CreateTeleporter( 67, 352, -7, 61, 525, 6, map, false );
				CreateTeleporter( 67, 353, -7, 61, 525, 6, map, false );
				CreateTeleporter( 60, 523, 11, 67, 353, -7, map, false );
				CreateTeleporter( 60, 524, 11, 67, 353, -7, map, false );
				CreateTeleporter( 60, 525, 11, 67, 353, -7, map, false );
				CreateTeleporter( 60, 526, 11, 67, 353, -7, map, false );

				// Fan Dancer Level 2
				CreateTeleporter( 105, 555, -5, 73, 690, -1, map, false );
				CreateTeleporter( 105, 556, -5, 73, 690, -1, map, false );
				CreateTeleporter( 105, 557, -5, 73, 690, -1, map, false );
				CreateTeleporter( 72, 688, 11, 105, 557, -5, map, false );
				CreateTeleporter( 72, 689, 11, 105, 557, -5, map, false );
				CreateTeleporter( 72, 690, 11, 105, 557, -5, map, false );
				CreateTeleporter( 72, 691, 11, 105, 557, -5, map, false );
				CreateTeleporter( 72, 692, 11, 105, 557, -5, map, false );
				CreateTeleporter( 72, 693, 11, 105, 557, -5, map, false );
				CreateTeleporter( 72, 694, 11, 105, 557, -5, map, false );

				// Ninja DE
				CreateTeleporter( 384, 810, -1, 404, 1168, 0, map, false );

				// Cave DE
				CreateTeleporter( 403, 1169, 0, 385, 810, 0, map, false );
				CreateTeleporter( 404, 1169, 0, 385, 810, 0, map, false );
				CreateTeleporter( 405, 1169, 0, 385, 810, 0, map, false );

				// Yomotsu Mines Entrance
				CreateTeleporter( 3, 128, -1, 260, 783, 63, map, Map.Tokuno, false );
				CreateTeleporter( 4, 128, -1, 260, 783, 63, map, Map.Tokuno, false );
				CreateTeleporter( 5, 128, -1, 260, 783, 63, map, Map.Tokuno, false );
				CreateTeleporter( 6, 128, -1, 260, 783, 63, map, Map.Tokuno, false );
				CreateTeleporter( 7, 128, -1, 260, 783, 63, map, Map.Tokuno, false );
				CreateTeleporter( 8, 128, -1, 260, 783, 63, map, Map.Tokuno, false );
			}

			public void CreateTeleportersTokuno( Map map_from, Map map_to )
			{
				// Fan Dancer Entrance
				CreateTeleporter( 988, 194, 15, 65, 337, 6, map_from, map_to, false );
				CreateTeleporter( 988, 195, 15, 65, 337, 6, map_from, map_to, false );
				CreateTeleporter( 988, 196, 15, 65, 337, 6, map_from, map_to, false );
				CreateTeleporter( 988, 197, 15, 65, 337, 6, map_from, map_to, false );

				// Yomotsu Mines Entrance
				CreateTeleporter( 257, 783, 63, 5, 125, -1, map_from, map_to, false );
				CreateTeleporter( 258, 783, 63, 5, 125, -1, map_from, map_to, false );
				CreateTeleporter( 259, 783, 63, 5, 125, -1, map_from, map_to, false );
				CreateTeleporter( 260, 783, 63, 5, 125, -1, map_from, map_to, false );
			}
			...
			public void CreateTeleportersTerMur()
			{
				// Underworld Entrance from Fire Island...
				CreateTeleporter( 4194, 3260, 5, 1127, 1214, 0, Map.Trammel, Map.TerMur, false );
				CreateTeleporter( 4195, 3260, 5, 1128, 1214, 0, Map.Trammel, Map.TerMur, false );

				// ... and back
				CreateTeleporter( 1125, 1215, 5, 4194, 3261, 5, Map.TerMur, Map.Trammel, false );
				CreateTeleporter( 1126, 1215, 5, 4194, 3261, 5, Map.TerMur, Map.Trammel, false );
				CreateTeleporter( 1127, 1215, 5, 4194, 3261, 5, Map.TerMur, Map.Trammel, false );
				CreateTeleporter( 1128, 1215, 5, 4195, 3261, 5, Map.TerMur, Map.Trammel, false );
				CreateTeleporter( 1129, 1215, 5, 4195, 3261, 5, Map.TerMur, Map.Trammel, false );
				CreateTeleporter( 1130, 1215, 5, 4195, 3261, 5, Map.TerMur, Map.Trammel, false );
				CreateTeleporter( 1131, 1215, 5, 4195, 3261, 5, Map.TerMur, Map.Trammel, false );

				// Stygian Abyss Entrace from the Underworld...
				CreateTeleporter( 1125, 1076, -117, 521, 920, 39, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 1126, 1076, -117, 521, 920, 39, Map.TerMur, Map.TerMur, false );

				// ... and back
				CreateTeleporter( 519, 919, 39, 1125, 1075, -117, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 520, 919, 39, 1125, 1075, -117, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 521, 919, 39, 1126, 1075, -117, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 522, 919, 39, 1126, 1075, -117, Map.TerMur, Map.TerMur, false );

				// Tomb of Kings entrance from Holy City...
				CreateTeleporter( 997, 3841, -41, 34, 240, 5, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 998, 3841, -41, 35, 240, 5, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 999, 3841, -41, 36, 240, 5, Map.TerMur, Map.TerMur, false );

				// ... and back
				CreateTeleporter( 33, 241, 7, 997, 3842, -41, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 34, 241, 7, 997, 3842, -41, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 35, 241, 7, 998, 3842, -41, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 36, 241, 7, 999, 3842, -41, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 37, 241, 7, 999, 3842, -41, Map.TerMur, Map.TerMur, false );

				// Stygian Abyss entrance from the Tomb of Kings
				CreateTeleporter( 37, 28, 0, 946, 70, 72, Map.TerMur, Map.TerMur, true );

				// Stygian Dragon's Lair Entrance
				CreateTeleporter( 841, 272, 30, 433, 152, 0, Map.TerMur, true );
				CreateTeleporter( 841, 273, 30, 433, 153, 0, Map.TerMur, true );
				CreateTeleporter( 841, 287, 30, 433, 167, 0, Map.TerMur, true );

				// Stygian Dragon's Lair Exit to the Abyss
				for ( int i = 0; i < 6; i++ )
					CreateTeleporter( 433, 154 + i, 0, 841, 273, 30, Map.TerMur, false );

				for ( int i = 0; i < 7; i++ )
					CreateTeleporter( 433, 160 + i, 0, 841, 287, 30, Map.TerMur, false );

				// Navrey Night-Eyes Lair
				CreateTeleporter( 1078, 972, -20, 1080, 884, -4, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 1079, 972, -20, 1080, 884, -4, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 1079, 973, -20, 1080, 884, -4, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 1080, 973, -20, 1080, 884, -4, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 1081, 973, -20, 1080, 884, -4, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 1082, 973, -20, 1080, 884, -4, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 1082, 973, -20, 1080, 884, -4, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 1080, 974, -20, 1080, 884, -4, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 1081, 974, -20, 1080, 884, -4, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 1080, 975, -20, 1080, 884, -4, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 1081, 975, -20, 1080, 884, -4, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 1082, 975, -20, 1080, 884, -4, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 1080, 976, -20, 1080, 884, -4, Map.TerMur, Map.TerMur, false );
				CreateTeleporter( 1081, 976, -20, 1080, 884, -4, Map.TerMur, Map.TerMur, false );

				// back
				CreateTeleporter( 1078, 882, 0, 1080, 978, -23, Map.TerMur, Map.TerMur, false );

				// Stygian Dragon's Lair
				CreateTeleporter( 79, 379, 5, 52, 389, 65, Map.TerMur, Map.TerMur, true );
				CreateTeleporter( 52, 343, 65, 80, 338, 85, Map.TerMur, Map.TerMur, true );
				CreateTeleporter( 45, 366, 85, 81, 399, 105, Map.TerMur, Map.TerMur, true );
				CreateTeleporter( 40, 366, 105, 79, 353, 5, Map.TerMur, Map.TerMur, true );

				CreateTeleporter( 79, 577, 5, 52, 587, 65, Map.TerMur, Map.TerMur, true );
				CreateTeleporter( 52, 541, 65, 80, 536, 85, Map.TerMur, Map.TerMur, true );
				CreateTeleporter( 45, 564, 85, 81, 597, 105, Map.TerMur, Map.TerMur, true );
				CreateTeleporter( 40, 564, 105, 79, 551, 5, Map.TerMur, Map.TerMur, true );

				CreateTeleporter( 79, 785, 5, 52, 795, 65, Map.TerMur, Map.TerMur, true );
				CreateTeleporter( 52, 749, 65, 80, 744, 85, Map.TerMur, Map.TerMur, true );
				CreateTeleporter( 45, 772, 85, 81, 805, 105, Map.TerMur, Map.TerMur, true );
				CreateTeleporter( 40, 772, 105, 79, 759, 5, Map.TerMur, Map.TerMur, true );
			}
			...
			public int CreateTeleporters()
			{
				...
				CreateTeleportersTokuno( Map.Tokuno, Map.Malas );
				CreateTeleportersTerMur();
