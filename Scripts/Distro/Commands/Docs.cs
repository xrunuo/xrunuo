...
namespace Server.Scripts.Commands
{
	public class Docs
	{
		...
		{
			CommandSystem.Register( "DocGen", AccessLevel.Owner, new CommandEventHandler( DocGen_OnCommand ) );
			CommandSystem.Register( "DocumentCommands", AccessLevel.Owner, new CommandEventHandler( DocumentCommands_OnCommand ) );
		}

		[Usage( "DocGen" )]
		[Description( "Generates X-RunUO documentation." )]
		...
		[Usage( "DocumentCommands" )]
		[Description( "Generates X-RunUO command documentation." )]
		private static void DocumentCommands_OnCommand( CommandEventArgs e )
		{
		...
		private static void GenerateIndex()
		{
			using ( StreamWriter html = GetWriter( "docs/", "index.html" ) )
			{
				html.WriteLine( "<html>" );
				html.WriteLine( "   <head>" );
				html.WriteLine( "      <title>X-RunUO Documentation - Index</title>" );
		...
		private static void DocumentBulkOrders()
		{
			using ( StreamWriter html = GetWriter( "docs/bods/", "bod_smith_rewards.html" ) )
			{
				html.WriteLine( "<html>" );
				html.WriteLine( "   <head>" );
				html.WriteLine( "      <title>X-RunUO Documentation - Bulk Orders - Smith Rewards</title>" );
				html.WriteLine( "      <link rel=\"stylesheet\" type=\"text/css\" href=\"../styles.css\" />" );
				html.WriteLine( "   </head>" );
				html.WriteLine( "   <body>" );
			...
			using ( StreamWriter html = GetWriter( "docs/bods/", "bod_tailor_rewards.html" ) )
			{
				html.WriteLine( "<html>" );
				html.WriteLine( "   <head>" );
				html.WriteLine( "      <title>X-RunUO Documentation - Bulk Orders - Tailor Rewards</title>" );
				html.WriteLine( "      <link rel=\"stylesheet\" type=\"text/css\" href=\"../styles.css\" />" );
				html.WriteLine( "   </head>" );
				html.WriteLine( "   <body>" );
		...
		{
			LargeBOD lbod = new LargeSmithBOD( 0.0 );
		...
		private static void DocumentBodies()
		{
			...
			using ( StreamWriter html = GetWriter( "docs/", "bodies.html" ) )
			{
				html.WriteLine( "<html>" );
				html.WriteLine( "   <head>" );
				html.WriteLine( "      <title>X-RunUO Documentation - Body List</title>" );
				html.WriteLine( "      <link rel=\"stylesheet\" type=\"text/css\" href=\"styles.css\" />" );
				html.WriteLine( "   </head>" );
				html.WriteLine( "   <body>" );
		...
		private static void DocumentKeywords()
		{
			...
			using ( StreamWriter html = GetWriter( "docs/", "keywords.html" ) )
			{
				html.WriteLine( "<html>" );
				html.WriteLine( "   <head>" );
				html.WriteLine( "      <title>X-RunUO Documentation - Speech Keywords</title>" );
				html.WriteLine( "      <link rel=\"stylesheet\" type=\"text/css\" href=\"styles.css\" />" );
				html.WriteLine( "   </head>" );
				html.WriteLine( "   <body>" );
				html.WriteLine( "      <h4><a href=\"index.html\">Back to the index</a></h4>" );
		...
		private static void DocumentCommands()
		{
			using ( StreamWriter html = GetWriter( "docs/", "commands.html" ) )
			{
				html.WriteLine( "<html>" );
				html.WriteLine( "   <head>" );
				html.WriteLine( "      <title>X-RunUO Documentation - Commands</title>" );
				html.WriteLine( "      <link rel=\"stylesheet\" type=\"text/css\" href=\"styles.css\" />" );
				html.WriteLine( "   </head>" );
				html.WriteLine( "   <body>" );
				html.WriteLine( "      <a name=\"Top\" />" );
					...
					if ( e.AccessLevel != last )
					{
						...
						switch ( last )
						{
							case AccessLevel.Owner:
								html.WriteLine( "      <b>Owner</b> | <a href=\"#Developer\">Developer</a> | <a href=\"#Administrator\">Administrator</a> | <a href=\"#Seer\">Seer</a> | <a href=\"#GameMaster\">Game Master</a> | <a href=\"#Counselor\">Counselor</a> | <a href=\"#Player\">Player</a><br><br>" );
								break;
							case AccessLevel.Developer:
								html.WriteLine( "      <a href=\"#Owner\">Owner</a> | <b>Developer</b> | <a href=\"#Administrator\">Administrator</a> | <a href=\"#Seer\">Seer</a> | <a href=\"#GameMaster\">Game Master</a> | <a href=\"#Counselor\">Counselor</a> | <a href=\"#Player\">Player</a><br><br>" );
								break;
							case AccessLevel.Administrator:
								html.WriteLine( "      <a href=\"#Owner\">Owner</a> | <a href=\"#Developer\">Developer</a> | <b>Administrator</b> | <a href=\"#Seer\">Seer</a> | <a href=\"#GameMaster\">Game Master</a> | <a href=\"#Counselor\">Counselor</a> | <a href=\"#Player\">Player</a><br><br>" );
								break;
							case AccessLevel.Seer:
								html.WriteLine( "      <a href=\"#Owner\">Owner</a> | <a href=\"#Developer\">Developer</a> | <a href=\"#Administrator\">Administrator</a> | <b>Seer</b> | <a href=\"#GameMaster\">Game Master</a> | <a href=\"#Counselor\">Counselor</a> | <a href=\"#Player\">Player</a><br><br>" );
								break;
							case AccessLevel.GameMaster:
								html.WriteLine( "      <a href=\"#Owner\">Owner</a> | <a href=\"#Developer\">Developer</a> | <a href=\"#Administrator\">Administrator</a> | <a href=\"#Seer\">Seer</a> | <b>GameMaster</b> | <a href=\"#Counselor\">Counselor</a> | <a href=\"#Player\">Player</a><br><br>" );
								break;
							case AccessLevel.Counselor:
								html.WriteLine( "      <a href=\"#Owner\">Owner</a> | <a href=\"#Developer\">Developer</a> | <a href=\"#Administrator\">Administrator</a> | <a href=\"#Seer\">Seer</a> | <a href=\"#GameMaster\">Game Master</a> | <b>Counselor</b> | <a href=\"#Player\">Player</a><br><br>" );
								break;
							case AccessLevel.Player:
								html.WriteLine( "      <a href=\"#Owner\">Owner</a> | <a href=\"#Developer\">Developer</a> | <a href=\"#Administrator\">Administrator</a> | <a href=\"#Seer\">Seer</a> | <a href=\"#GameMaster\">Game Master</a> | <a href=\"#Counselor\">Counselor</a> | <b>Player</b>" );
								break;
						}
		...
		private static void DocumentCommand( StreamWriter html, DocCommandEntry e )
		{
			...
			{
				html.Write( "<td class=\"rentry\"><b>Uso: {0}</b><br>{1}</td>", usage.Replace( "<", "&lt;" ).Replace( ">", "&gt;" ), desc );
			}
			else
			{
				html.Write( "<td class=\"rentry\"><b>Uso: {0}</b><br>Alias{1}: ", usage.Replace( "<", "&lt;" ).Replace( ">", "&gt;" ), aliases.Length == 1 ? "" : "es" );
		...
		private static void LoadTypes( Assembly a, Assembly[] asms )
		{
			...
			for ( int i = 0; i < types.Length; ++i )
			{
				...
				if ( nspace == null || type.IsSpecialName || type.Name.StartsWith( "<>c__" ) )
				{
					continue;
				}
		...
		private static void DocumentConstructableObjects()
		{
			...
			using ( StreamWriter html = GetWriter( "docs/", "objects.html" ) )
			{
				html.WriteLine( "<html>" );
				html.WriteLine( "   <head>" );
				html.WriteLine( "      <title>X-RunUO Documentation - Constructable Objects</title>" );
				html.WriteLine( "      <link rel=\"stylesheet\" type=\"text/css\" href=\"styles.css\" />" );
				html.WriteLine( "   </head>" );
				html.WriteLine( "   <body>" );
				html.WriteLine( "      <h4><a href=\"index.html\">Back to the index</a></h4>" );
		...
		private static void DocumentLoadedTypes()
		{
			using ( StreamWriter indexHtml = GetWriter( "docs/", "overview.html" ) )
			{
				...
				indexHtml.WriteLine( "      <title>X-RunUO Documentation - Class Overview</title>" );
				indexHtml.WriteLine( "   </head>" );
		...
		private static void SaveNamespace( string name, ArrayList types, StreamWriter indexHtml )
		{
			...
			using ( StreamWriter nsHtml = GetWriter( "docs/namespaces/", fileName ) )
			{
				...
				nsHtml.WriteLine( "      <title>X-RunUO Documentation - Class Overview - {0}</title>", name );
				nsHtml.WriteLine( "   </head>" );
		...
		private static void SaveType( TypeInfo info, StreamWriter nsHtml, string nsFileName, string nsName )
		{
			...
			using ( StreamWriter typeHtml = info.m_Writer )
			{
				...
				typeHtml.WriteLine( "      <title>X-RunUO Documentation - Class Overview - {0}</title>", info.m_TypeName );
				typeHtml.WriteLine( "   </head>" );
