...
namespace Server.Scripts.Commands
{
	public class Add
	{
		...
		private static Type[] m_SignedNumerics = new Type[] { typeof( Int64 ), typeof( Int32 ), typeof( Int16 ), typeof( SByte ) };
		...
		private static Type[] m_UnsignedNumerics = new Type[] { typeof( UInt64 ), typeof( UInt32 ), typeof( UInt16 ), typeof( Byte ) };
