...
namespace Server.Scripts.Commands
{
	public class SkillsCommand
	{
		public static void Initialize()
		{
			...
			CommandSystem.Register( "GetSkill", AccessLevel.Counselor, new CommandEventHandler( GetSkill_OnCommand ) );
		...
		[Usage( "SetSkill <skill name> <value>" )]
		...
		[Usage( "SetSkillCap <skill name> <value>" )]
		[Description( "Sets a skill cap value by name of a targeted mobile." )]
