...
namespace Server.SkillHandlers
{
	public class Tracking
	{
		...
		public static double GetStalkingBonus( Mobile tracker, Mobile target )
		{
			...
			// OSI Publish 40: Stalking bonus cap at 10 + 1/10 skill.
			int cap = 10 + ( (int) ( tracker.Skills[SkillName.Tracking].Value / 10 ) );

			// OSI Publish 40: Stalking bonus clears itself correctly.
			ClearTrackingInfo( tracker );
	...
	{
		public override int TypeID { get { return 0xBC7230; } }
	...
	{
		public override int TypeID { get { return 0xBC7231; } }
