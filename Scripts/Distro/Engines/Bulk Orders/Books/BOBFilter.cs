...
namespace Server.Engines.BulkOrders
{
	public class BOBFilter
	{
		...
		public bool IsDefault { get { return ( m_Type == 0 && m_Quality == 0 && m_Material == 0 && m_Quantity == 0 ); } }
		...
		public int Quality { get { return m_Quality; } set { m_Quality = value; } }

		public int Material { get { return m_Material; } set { m_Material = value; } }
