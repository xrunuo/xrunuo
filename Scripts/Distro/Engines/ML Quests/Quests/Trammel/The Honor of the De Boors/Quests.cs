...
{
	public class TheHonorOfTheDeBoorsQuest : BaseQuest
	{
		public override QuestChain ChainID { get { return QuestChain.TheHonorOfTheDeBoors; } }
		...
		public TheHonorOfTheDeBoorsQuest()
			: base()
		{
	...
	public class JackTheVillainQuest : BaseQuest
	{
		...
		public JackTheVillainQuest()
			: base()
		{
			AddObjective( new DeliverObjective( typeof( BagOfJewels ), "Bag of Jewels", 1, typeof( Jack ), "Jack" ) );
	...
	public class SavedHonorQuest : BaseQuest
	{
		...
		/* That idiot! This beat up piece of junk isn’t worth more than three gold coins, four at most! Oh, well, a deal’s a deal! */
		...
		/* My shield! My family’s honor! You have my gratitude. Please, take this goblet. It is small enough repayment
		for all you have done for me, but it is the only thing of my family’s that I have left. */
		public override object Complete { get { return 1075433; } }

		public SavedHonorQuest()
			: base()
		{
			AddObjective( new DeliverObjective( typeof( AncestralShield ), "Ancestral Shield", 1, typeof( Derek ), "Derek" ) );
