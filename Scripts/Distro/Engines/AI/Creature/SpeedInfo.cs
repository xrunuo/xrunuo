		...
		private static SpeedInfo[] m_Speeds = new SpeedInfo[]
			{
				...
				new SpeedInfo( 0.3, 0.6, new Type[]
				{
					...
					typeof( Juggernaut ),		typeof( RuddyBoura ),		typeof( LowlandBoura ),
				...
				new SpeedInfo( 0.2, 0.4, new Type[]
				{
					...
					typeof( GiantBlackWidow ),	typeof( DemonKnight ),		typeof( SummonedAirElemental ),
					typeof( SentinelSpider )
				} ),
				/* Very Fast */
				new SpeedInfo( 0.175, 0.350, new Type[]
				{
					...
					typeof( Leviathan ),		typeof( NavreyNightEyes ),	typeof( FactionDeathKnight ),
					typeof( Raptor ),			typeof( TrapdoorSpider )
				} ),
				/* Medium */
				new SpeedInfo( 0.25, 0.5, new Type[]
				{
					...
					typeof( BlackSolenQueen ),	typeof( BlackSolenWorker ),	typeof( BlackSolenWarrior ),
					...
					typeof( Eagle ),			typeof( ElderGazer ),		typeof( DullCopperElemental ),
					...
					typeof( RedSolenQueen ),	typeof( RedSolenWorker ),	typeof( RedSolenInfiltratorQueen ),
					typeof( RedSolenWarrior ),	typeof( RidableLlama ),		typeof( RedSolenInfiltratorWarrior ),
					...
					typeof( SwampTentacle ),	typeof( TerathanAvenger ),	typeof( ScaledSwampDragon ), 
					typeof( TerathanDrone ),	typeof( TerathanWarrior ),	typeof( TerathanMatriarch ),
					typeof( TimberWolf ),		typeof( Titan ),			typeof( Troll ),
					typeof( Unicorn ),			typeof( VeriteElemental ),	typeof( ValoriteElemental ),
					...
					typeof( KhaldunZealot ),	typeof( KhaldunSummoner ),	typeof( SummonedFireElemental ),
					typeof( LichLord ),			typeof( SkeletalKnight ),	typeof( SummonedEarthElemental ),
					typeof( MeerCaptain ),		typeof( MeerMage ),			typeof( SummonedWaterElemental ), 
					typeof( MeerWarrior ),		typeof( MeerEternal ),		typeof( SummonedDaemon ),
					typeof( JukaWarrior ),		typeof( JukaLord ),			typeof( JukaMage ),
					typeof( SavageRidgeback ),	typeof( AbysmalHorror ),	typeof( BoneDemon ),
					...
					typeof( Cursed ),			typeof( GrimmochDrummel ),	typeof( WandererOfTheVoid ),
					typeof( MorgBergen ),		typeof( ShadowFiend ),		typeof( LysanderGathenwale ),
					...
					typeof( ExodusOverseer ),	typeof( Moloch ),			typeof( GargoyleDestroyer ),
					typeof( GargoyleEnforcer ),	typeof( ColdDrake )
				} )
			};
	}
}