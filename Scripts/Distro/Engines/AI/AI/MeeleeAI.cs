...
namespace Server.Mobiles
{
	public class MeleeAI : BaseAI
	{
		...
		public override bool DoActionCombat()
		{
			...
			if ( combatant == null || combatant.Deleted || combatant.Map != m_Mobile.Map || !combatant.Alive || combatant.IsDeadBondedPet || !m_Mobile.InRange( combatant, m_Mobile.RangePerception ) )
			{
