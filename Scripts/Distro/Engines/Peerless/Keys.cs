...
namespace Server.Items
{
	...
	{
		private static PeerlessEntry[] m_Table =
		{
			new PeerlessEntry(
				PeerlessList.DreadHorn,
				6, typeof( DreadHornActivation ), "Essence Of The Wind",
				typeof( DreadHorn ),
				Map.Ilshenar,
				new Point3D( 2138, 1248, -60 ),
				new Point3D( 1311, 928, 6 ),
				typeof( BlightedCotton ), typeof( GnawsFang ), typeof( IrksBrain ), typeof( LissithsSilk ), typeof( SabrixsEye ), typeof( ThornyBriar )
			),
			new PeerlessEntry(
				PeerlessList.MelisandeTrammel,
				1,
				typeof( MelisandeActivationTrammel ), "Dryad's Curse",
				typeof( LadyMelisande ),
				Map.Trammel,
				new Point3D( 6492, 946, 16 ),
				new Point3D( 577, 1640, 0 ),
				typeof( DryadsBlessing )
			),
			new PeerlessEntry(
				PeerlessList.MelisandeFelucca,
				1, typeof( MelisandeActivationFelucca ), "Dryad's Curse",
				typeof( LadyMelisande ),
				Map.Felucca,
				new Point3D( 6492, 946, 16 ),
				new Point3D( 577, 1640, 0 ),
			...
			new PeerlessEntry(
				PeerlessList.Travesty,
				3, typeof( BlackOrderKey ), "Black Order Key",
				typeof( Travesty ),
				Map.Malas, new Point3D( 87, 1955, 0 ),
				new Point3D( 1355, 779, 17 ),
				typeof( DragonFlameKey ), typeof( SerpentFangKey ), typeof( TigerClawKey )
			),
			new PeerlessEntry(
				PeerlessList.InterredGrizzle,
				1, typeof( MasterKey ), "Master Key",
				typeof( MonstrousInterredGrizzle ),
				Map.Malas,
				new Point3D( 178, 1734, 90 ),
				new Point3D( 2068, 1372, -75 ),
				typeof( LibrariansKey )
			),
			new PeerlessEntry(
				PeerlessList.ParoxysmusTrammel,
				4, typeof( SlimyOintmentTrammel ), "Slimy Ointment",
				typeof( ChiefParoxysmus ),
				Map.Trammel, new Point3D( 6517, 357, 0 ),
				new Point3D( 5623, 3038, 15 ),
				typeof( CoagulatedLegs ), typeof( GelatanousSkull ), typeof( PartiallyDigestedTorso ), typeof( SpleenOfThePutrefier )
			),
			new PeerlessEntry(
				PeerlessList.ParoxysmusFelucca,
				4, typeof( SlimyOintmentFelucca ), "Slimy Ointment",
				typeof( ChiefParoxysmus ),
				Map.Felucca,
				new Point3D( 6517, 357, 0 ),
				new Point3D( 5623, 3038, 15 ),
				typeof( CoagulatedLegs ), typeof( GelatanousSkull ), typeof( PartiallyDigestedTorso ), typeof( SpleenOfThePutrefier )
			),
			new PeerlessEntry(
				PeerlessList.ShimmeringEffusionTrammel,
				6, typeof( ShimmeringEffusionActivationTrammel ), "Master Key",
				typeof( ShimmeringEffusion ),
				Map.Trammel,
				new Point3D( 6511, 117, -20 ),
				new Point3D( 3785, 1107, 20 ),
				typeof( BrokenCrystals ), typeof( CrushedCrystals ), typeof( JaggedCrystals ), typeof( PiecesOfCrystal ), typeof( ScatteredCrystals ), typeof( ShatteredCrystals )
			),
			new PeerlessEntry(
				PeerlessList.ShimmeringEffusionFelucca,
				6, typeof( ShimmeringEffusionActivationFelucca ), "Master Key",
				typeof( ShimmeringEffusion ),
				Map.Felucca,
				new Point3D( 6511, 117, -20 ),
				new Point3D( 3785, 1107, 20 ),
			...
			new PeerlessEntry(
				PeerlessList.Dummy, 1, typeof( DreadHornActivation ), "Dryad's Curse",
				typeof( Dragon ),
				Map.Felucca,
				new Point3D( 2138, 1248, -60 ),
				new Point3D( 2174, 1261, -60 ),
				typeof( Robe )
			),
		};
