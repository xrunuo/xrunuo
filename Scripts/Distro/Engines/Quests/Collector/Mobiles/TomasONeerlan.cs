...
namespace Server.Engines.Quests.Collector
{
	public class TomasONeerlan : BaseQuester
	{
		...
		public override bool CanTalkTo( PlayerMobile to )
		{
			...
			return ( qs.IsObjectiveInProgress( typeof( FindTomasObjective ) ) || qs.IsObjectiveInProgress( typeof( CaptureImagesObjective ) ) || qs.IsObjectiveInProgress( typeof( ReturnImagesObjective ) ) );
		}
