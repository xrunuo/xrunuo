...
namespace Server.Engines.Quests.Collector
{
	public class GabrielPiete : BaseQuester
	{
		...
		public override bool CanTalkTo( PlayerMobile to )
		{
			...
			return ( qs.IsObjectiveInProgress( typeof( FindGabrielObjective ) ) || qs.IsObjectiveInProgress( typeof( FindSheetMusicObjective ) ) || qs.IsObjectiveInProgress( typeof( ReturnSheetMusicObjective ) ) || qs.IsObjectiveInProgress( typeof( ReturnAutographObjective ) ) );
		}
