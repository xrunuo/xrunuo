...
namespace Server.Engines.Quests.Collector
{
	public class Obsidian : Item
	{
		...
		{
			if ( m_Quantity < m_Partial )
				return new LocalizedText( 1055137 ); // a section of an obsidian statue
			else if ( m_Quantity < m_Completed )
				return new LocalizedText( 1055138 ); // a partially reconstructed obsidian statue
			else
				return new LocalizedText( 1055139, m_StatueName ); // an obsidian statue of ~1_STATUE_NAME~
		}
