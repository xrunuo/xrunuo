...
namespace Server.Engines.Quests
{
	...
	public abstract class QuestSystem
	{
		...
		public PlayerMobile From { get { return m_From; } set { m_From = value; } }

		public ArrayList Objectives { get { return m_Objectives; } set { m_Objectives = value; } }

		public ArrayList Conversations { get { return m_Conversations; } set { m_Conversations = value; } }
		...
		public virtual void OnAttack( BaseCreature creature )
		{
			for ( int i = m_Objectives.Count - 1; i >= 0; --i )
			{
				QuestObjective obj = (QuestObjective) m_Objectives[i];

				if ( obj.GetAttackEvent( creature ) )
					obj.OnAttack( creature );
			}
		}
	...
	{
		public override int TypeID { get { return 0x2B13; } }
			...
			: base( 120, 50 )
		{
			...
			{
				AddHtmlLocalized( 25, 60, 300, 20, 1049001, 0xFFFFFF, false, false ); // You have chosen to abort your quest:
				AddImage( 25, 81, 0x25E7 );
				AddHtmlObject( 48, 80, 280, 20, system.Name, DarkGreen, false, false );

				AddHtmlLocalized( 25, 120, 280, 20, 1049002, 0xFFFFFF, false, false ); // Can this quest be restarted after quitting?
			...
			AddHtmlLocalized( 60, 180, 280, 20, 1049005, 0xFFFFFF, false, false ); // Yes, I really want to quit!
			AddHtmlLocalized( 60, 215, 280, 20, 1049006, 0xFFFFFF, false, false ); // No, I don't want to quit.
	...
	{
		public override int TypeID { get { return 0x2B0F; } }
			...
			: base( 75, 25 )
		{
			...
			AddButton( 340, 390, 247, 248, 7, GumpButtonType.Reply, 0 );
