...
namespace Server.Engines.Quests
{
	public abstract class QuestObjective
	{
		...
		public QuestSystem System { get { return m_System; } set { m_System = value; } }

		public bool HasBeenRead { get { return m_HasBeenRead; } set { m_HasBeenRead = value; } }
		...
		public bool HasCompleted { get { return m_HasCompleted; } set { m_HasCompleted = value; } }

		public virtual bool Completed { get { return m_CurProgress >= MaxProgress; } }

		public bool IsSingleObjective { get { return ( MaxProgress == 1 ); } }
		...
		public virtual bool GetAttackEvent( BaseCreature creature )
		{
			return !Completed;
		}
	...
	{
		public override int TypeID { get { return 0x2B10; } }
	...
	{
		public override int TypeID { get { return 0x2B0E; } }
			...
			: base( 90, 50 )
		{
			...
			AddHtmlLocalized( 117, 35, 230, 20, 1046026, 0xFFFFFF, false, false ); // Quest Log

			AddImage( 77, 33, 9781 );
			AddImage( 65, 110, 2104 );

			AddHtmlLocalized( 79, 106, 230, 20, 1049073, 0xFFFFFF, false, false ); // Objective:

			AddImageTiled( 68, 125, 120, 1, 9101 );
			AddImage( 65, 240, 2104 );

			AddHtmlLocalized( 79, 237, 230, 20, 1049076, 0xFFFFFF, false, false ); // Progress details:
