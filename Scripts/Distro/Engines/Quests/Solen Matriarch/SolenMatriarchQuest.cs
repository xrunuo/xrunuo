...
namespace Server.Engines.Quests.Matriarch
{
	...
	{
		private static Type[] m_TypeReferenceTable = new Type[] { typeof( Matriarch.DontOfferConversation ), typeof( Matriarch.AcceptConversation ), typeof( Matriarch.DuringKillInfiltratorsConversation ), typeof( Matriarch.GatherWaterConversation ), typeof( Matriarch.DuringWaterGatheringConversation ), typeof( Matriarch.ProcessFungiConversation ), typeof( Matriarch.DuringFungiProcessConversation ), typeof( Matriarch.FullBackpackConversation ), typeof( Matriarch.EndConversation ), typeof( Matriarch.KillInfiltratorsObjective ), typeof( Matriarch.ReturnAfterKillsObjective ), typeof( Matriarch.GatherWaterObjective ), typeof( Matriarch.ReturnAfterWaterObjective ), typeof( Matriarch.ProcessFungiObjective ), typeof( Matriarch.GetRewardObjective ) };
