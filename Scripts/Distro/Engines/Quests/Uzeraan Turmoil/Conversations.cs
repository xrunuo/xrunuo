...
namespace Server.Engines.Quests.Haven
{
	...
	public class UzeraanFirstTaskConversation : QuestConversation
	{
		...
		private static QuestItemInfo[] m_Info = new QuestItemInfo[] {new QuestItemInfo( 1023676, 0xE68 ) // glowing rune
		};
	...
	public class UzeraanReportConversation : QuestConversation
	{
		...
		private static QuestItemInfo[] m_Info = new QuestItemInfo[] {new QuestItemInfo( 1026153, 0x1822 ), // teleporter
	...
	public class SchmendrickConversation : QuestConversation
	{
		...
		private static QuestItemInfo[] m_Info = new QuestItemInfo[] {new QuestItemInfo( 1023637, 0xE34 ) // scroll
		};
	...
	public class UzeraanScrollOfPowerConversation : QuestConversation
	{
		...
		private static QuestItemInfo[] m_Info = new QuestItemInfo[] {new QuestItemInfo( 1048030, 0x14EB ), // a Treasure Map
	...
	public class UzeraanFertileDirtConversation : QuestConversation
	{
		...
		private static QuestItemInfo[] m_Info = new QuestItemInfo[] {new QuestItemInfo( 1023965, 0xF7D ), // Daemon Blood
	...
	public class UzeraanDaemonBloodConversation : QuestConversation
	{
		...
		private static QuestItemInfo[] m_Info = new QuestItemInfo[] {new QuestItemInfo( 1017412, 0xF80 ), // Daemon Bone
		};

		private static QuestItemInfo[] m_InfoPaladin = new QuestItemInfo[] {new QuestItemInfo( 1017412, 0xF80 ), // Daemon Bone
