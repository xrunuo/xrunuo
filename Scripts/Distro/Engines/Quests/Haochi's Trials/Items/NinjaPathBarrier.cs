...
{
	public class NinjaPathBarrier : Item
	{
		[Constructable]
		public NinjaPathBarrier()
			: base( 0x49E )
		{
			Movable = false;
			Visible = false;
		...
		public override bool OnMoveOver( Mobile m )
		{
			...
			{
				QuestObjective obj = qs.FindObjective( typeof( KillNinjaObjective ) );
		...
		public NinjaPathBarrier( Serial serial )
			: base( serial )
		{
		}
