		...
		public override void OnTalk( PlayerMobile player, bool contextMenu )
		{
			...
			if ( qs is WitchApprenticeQuest )
			{
				...
				else
				{
					...
					else if ( qs.IsObjectiveInProgress( typeof( KillImpsObjective ) ) || qs.IsObjectiveInProgress( typeof( FindZeefzorpulObjective ) ) )
					{
						PlaySound( 0x259 );
						PlaySound( 0x206 );
					...
					else
					{
						...
						else
						{
							...
							if ( obj != null && !obj.Completed )
							{
								...
								cont.DropItem( new Gold( Utility.RandomMinMax( 2000, 2200 ) ) );
