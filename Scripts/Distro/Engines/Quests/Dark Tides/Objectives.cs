...
namespace Server.Engines.Quests.Necro
{
	public class AnimateMaabusCorpseObjective : QuestObjective
	{
		...
		private static QuestItemInfo[] m_Info = new QuestItemInfo[] {new QuestItemInfo( 1023643, 8787 ) // spellbook
		};
	...
	public class FindVaultOfSecretsObjective : QuestObjective
	{
		...
		private static QuestItemInfo[] m_Info = new QuestItemInfo[] {new QuestItemInfo( 1023676, 3679 ) // glowing rune
		};
	...
	public class ReturnToCrystalCaveObjective : QuestObjective
	{
		...
		private static QuestItemInfo[] m_Info = new QuestItemInfo[] {new QuestItemInfo( 1026153, 6178 ) // teleporter
		};
