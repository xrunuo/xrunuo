...
namespace Server.Factions
{
	public class FactionImbueGump : FactionGump
	{
		...
		public FactionImbueGump( bool exceptional, Item item, Mobile from, CraftSystem craftSystem, BaseTool tool, object notice, int availableSilver, Faction faction, FactionItemDefinition def )
			: base( 100, 200 )
		{
			m_Item = item;
			m_Mobile = from;
			...
			AddHtmlLocalized( 175, 60, 100, 25, m_Exceptional ? 1018303 : 1018304, false, false ); // Exceptional, Average
