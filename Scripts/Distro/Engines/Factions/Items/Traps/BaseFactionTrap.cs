...
namespace Server.Factions
{
	...
	public abstract class BaseFactionTrap : BaseTrap
	{
		...
		public virtual TimeSpan DecayPeriod { get { return TimeSpan.FromDays( 1.0 ); } }

		public override bool RevealOnTrigger { get { return false; } }
		...
		public virtual int IsValidLocation( Point3D p, Map m )
		{
			...
			// Check if another trap exists in this point
			if ( m.GetItemsAtWorldPoint( p ).OfType<BaseFactionTrap>().Any() )
			{
