...
namespace Server.Factions
{
	public class Sigil : BaseSystemController, IComparable
	{
		...
		public static readonly TimeSpan CorruptionGrace = TimeSpan.FromMinutes( 30.0 );

		// Sigil must be held at a stronghold for this amount of time in order to become corrupted
		public static readonly TimeSpan CorruptionPeriod = TimeSpan.FromHours( 10.0 );
		...
		private Mobile m_OriginalThief;
		private Mobile m_PreviousThief;
		...
		public DateTime LastStolen { get { return m_LastStolen; } set { m_LastStolen = value; } }

		[CommandProperty( AccessLevel.Counselor, AccessLevel.Administrator )]
		public DateTime GraceStart { get { return m_GraceStart; } set { m_GraceStart = value; } }

		[CommandProperty( AccessLevel.Counselor, AccessLevel.Administrator )]
		public DateTime CorruptionStart { get { return m_CorruptionStart; } set { m_CorruptionStart = value; } }

		[CommandProperty( AccessLevel.Counselor, AccessLevel.Administrator )]
		public DateTime PurificationStart { get { return m_PurificationStart; } set { m_PurificationStart = value; } }
		...
		[CommandProperty( AccessLevel.Counselor, AccessLevel.Administrator )]
		public BaseMonolith LastMonolith { get { return m_LastMonolith; } set { m_LastMonolith = value; } }

		[CommandProperty( AccessLevel.Counselor )]
		public bool IsBeingCorrupted { get { return ( m_LastMonolith is StrongholdMonolith && m_LastMonolith.Faction == m_Corrupting && m_Corrupting != null ); } }

		[CommandProperty( AccessLevel.Counselor )]
		public bool IsCorrupted { get { return ( m_Corrupted != null ); } }

		[CommandProperty( AccessLevel.Counselor )]
		public bool IsPurifying { get { return ( m_PurificationStart != DateTime.MinValue ); } }

		[CommandProperty( AccessLevel.Counselor )]
		public bool IsCorrupting { get { return ( m_Corrupting != null && m_Corrupting != m_Corrupted ); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public Mobile OriginalThief { get { return ( m_OriginalThief ); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public Mobile PreviousThief { get { return ( m_PreviousThief ); } }
		...
		private void UpdateThief( Mobile thief )
		{
			m_PreviousThief = m_OriginalThief;
			m_OriginalThief = thief;
		}

		public void RestoreThief( Faction killerfaction )
		{
			Faction previousfaction = Faction.Find( m_PreviousThief );

			if ( previousfaction != killerfaction )
				return;

			Mobile swapvar = m_OriginalThief;

			m_OriginalThief = m_PreviousThief;
			m_PreviousThief = swapvar;
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
				case 2:
					{
						m_PreviousThief = reader.ReadMobile();
						goto case 1;
					}
				case 1:
					{
						m_OriginalThief = reader.ReadMobile();
						goto case 0;
					}
				case 0:
					{
