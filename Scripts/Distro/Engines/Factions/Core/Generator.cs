...
namespace Server.Factions
{
	public class Generator
	{
		...
		{
			CommandSystem.Register( "GenerateFactions", AccessLevel.Developer, new CommandEventHandler( GenerateFactions_OnCommand ) );
		}

		[Usage( "GenerateFactions" )]
		[Description( "Genera el sistema de facciones." )]
