...
namespace Server.Factions
{
	...
	public class VendorListCollection : System.Collections.CollectionBase
	{
		...
		/// </summary>
		public Server.Factions.VendorList this[int index] { get { return ( (Server.Factions.VendorList) ( this.List[index] ) ); } set { this.List[index] = value; } }
		...
		new public VendorListCollectionEnumerator GetEnumerator()
		{
