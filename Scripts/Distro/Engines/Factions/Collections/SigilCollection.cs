...
namespace Server.Factions
{
	...
	public class SigilCollection : System.Collections.CollectionBase
	{
		...
		/// </summary>
		public Server.Factions.Sigil this[int index] { get { return ( (Server.Factions.Sigil) ( this.List[index] ) ); } set { this.List[index] = value; } }
		...
		new public SigilCollectionEnumerator GetEnumerator()
		{
