...
namespace Server.Factions
{
	...
	public class FactionGuardCollection : System.Collections.CollectionBase
	{
		...
		/// </summary>
		public Server.Factions.BaseFactionGuard this[int index] { get { return ( (Server.Factions.BaseFactionGuard) ( this.List[index] ) ); } set { this.List[index] = value; } }
		...
		new public FactionGuardCollectionEnumerator GetEnumerator()
		{
