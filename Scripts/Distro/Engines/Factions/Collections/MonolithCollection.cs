...
namespace Server.Factions
{
	...
	public class MonolithCollection : System.Collections.CollectionBase
	{
		...
		/// </summary>
		public Server.Factions.BaseMonolith this[int index] { get { return ( (Server.Factions.BaseMonolith) ( this.List[index] ) ); } set { this.List[index] = value; } }
		...
		new public MonolithCollectionEnumerator GetEnumerator()
		{
