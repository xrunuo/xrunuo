...
namespace Server.Factions
{
	...
	public class PlayerStateCollection : System.Collections.CollectionBase
	{
		...
		/// </summary>
		public Server.Factions.PlayerState this[int index] { get { return ( (Server.Factions.PlayerState) ( this.List[index] ) ); } set { this.List[index] = value; } }
		...
		new public PlayerStateCollectionEnumerator GetEnumerator()
		{
