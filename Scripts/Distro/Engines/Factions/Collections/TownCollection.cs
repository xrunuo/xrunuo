...
namespace Server.Factions
{
	...
	public class TownCollection : System.Collections.CollectionBase
	{
		...
		/// </summary>
		public Server.Factions.Town this[int index] { get { return ( (Server.Factions.Town) ( this.List[index] ) ); } set { this.List[index] = value; } }
		...
		new public TownCollectionEnumerator GetEnumerator()
		{
