...
namespace Server.Factions
{
	...
	public class GuardListCollection : System.Collections.CollectionBase
	{
		...
		/// </summary>
		public Server.Factions.GuardList this[int index] { get { return ( (Server.Factions.GuardList) ( this.List[index] ) ); } set { this.List[index] = value; } }
		...
		new public GuardListCollectionEnumerator GetEnumerator()
		{
