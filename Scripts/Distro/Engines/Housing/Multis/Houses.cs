using System;
using Server.Engines.Housing.Deeds.Items;
using Server.Engines.Housing.Items;
using Server.Items;

namespace Server.Engines.Housing.Multis
{
	[TypeAlias( "Server.Multis.SmallOldHouse" )]
	...
	[TypeAlias( "Server.Multis.GuildHouse" )]
	...
	[TypeAlias( "Server.Multis.TwoStoryHouse" )]
	...
	[TypeAlias( "Server.Multis.Castle" )]
	...
	[TypeAlias( "Server.Multis.LargePatioHouse" )]
	...
	[TypeAlias( "Server.Multis.LargeMarbleHouse" )]
	...
	[TypeAlias( "Server.Multis.SmallTower" )]
	...
	[TypeAlias( "Server.Multis.LogCabin" )]
	...
	[TypeAlias( "Server.Multis.SandStonePatio" )]
	...
	[TypeAlias( "Server.Multis.TwoStoryVilla" )]
	...
	[TypeAlias( "Server.Multis.SmallShop" )]
