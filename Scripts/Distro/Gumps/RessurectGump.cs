...
namespace Server.Gumps
{
	...
	public class ResurrectGump : Gump
	{
			...
			: base( 100, 0 )
		{
			...
			AddHtmlLocalized( 100, 230, 110, 35, 3000186, false, false ); // Continue
			AddHtmlLocalized( 235, 230, 110, 35, 1011012, false, false ); // CANCEL

			AddButton( 65, 227, 4005, 4007, 2, GumpButtonType.Reply, 0 );
			AddButton( 200, 227, 4005, 4007, 1, GumpButtonType.Reply, 0 );
		}
