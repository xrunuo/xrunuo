...
namespace Server.Gumps
{
	public class PropertiesGump : Gump
	{
		...
		public PropertiesGump( Mobile mobile, object o, Stack stack, IStackEntry parent )
			: base( GumpOffsetX, GumpOffsetY )
		{
			m_Mobile = mobile;
			m_Object = o;
		...
		{
			void SendGump( Mobile from, Stack stack );
		...
		public class StackEntry : IStackEntry
		{
			...
			{
				from.SendGump( new PropertiesGump( from, m_Object, stack, null ) );
			}

			public void OnValueChanged( object obj )
			{
				if ( m_Property.CanWrite )
					m_Property.SetValue( m_Object, obj, null );
			}
		}
				...
				case 0: // Closed
					{
						...
						{
							IStackEntry entry = (IStackEntry) m_Stack.Pop();

							entry.SendGump( from, m_Stack );
						}
		...
		public static void OnValueChanged( object obj, PropertyInfo prop, Stack stack )
		{
			...
			IStackEntry peek = (IStackEntry) stack.Peek();

			peek.OnValueChanged( obj );
		}
		...
		private static Type[] typeofNumeric = new Type[] { typeof( Byte ), typeof( Int16 ), typeof( Int32 ), typeof( Int64 ), typeof( SByte ), typeof( UInt16 ), typeof( UInt32 ), typeof( UInt64 ) };
