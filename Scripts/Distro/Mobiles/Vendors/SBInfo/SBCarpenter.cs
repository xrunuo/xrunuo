...
namespace Server.Mobiles
{
	public class SBCarpenter : SBInfo
	{
		...
		public class InternalBuyInfo : ArrayList
		{
			...
			{
				Add( new GenericBuyInfo( typeof( Lute ), 40, 20, 0xEB3, 0 ) );
				Add( new GenericBuyInfo( typeof( LapHarp ), 30, 20, 0xEB2, 0 ) );
				Add( new GenericBuyInfo( typeof( Tambourine ), 60, 20, 0xE9D, 0 ) );
