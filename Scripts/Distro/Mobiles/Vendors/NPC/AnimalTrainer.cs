...
namespace Server.Mobiles
{
	public class AnimalTrainer : BaseVendor
	{
		...
		private class ClaimListGump : Gump
		{
			...
			public ClaimListGump( AnimalTrainer trainer, Mobile from, ArrayList list )
				: base( 50, 50 )
			{
				m_Trainer = trainer;
				m_From = from;
		...
		public static int GetMaxStabled( Mobile from )
		{
			...
			// SA Accounts have 2 extra stable slots.
			// max += 2;
		...
		public virtual bool CheckCriminal( Mobile m )
		{
			if ( m.Criminal )
			{
				m.SendLocalizedMessage( 1071376 ); // Thou'rt a criminal and cannot use the stables...
				return false;
			}
