...
namespace Server.Mobiles
{
	public class CustomHairstylist : BaseVendor
	{
		...
		private static HairstylistBuyInfo[] m_HumanMaleSellList = new HairstylistBuyInfo[]
			{
				new HairstylistBuyInfo( 1018357, 50000, false, typeof( ChangeHairstyleGump ), new object[]
					{ From, Vendor, Price, false, ChangeHairstyleEntry.HumanMaleHairEntries } ),
				...
				new HairstylistBuyInfo( 1018359, 50, false, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, true, true, ChangeHairHueEntry.HumanRegularEntries } ),
				new HairstylistBuyInfo( 1018360, 500000, false, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, true, true, ChangeHairHueEntry.HumanBrightEntries } ),
				new HairstylistBuyInfo( 1018361, 30000, false, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, true, false, ChangeHairHueEntry.HumanRegularEntries } ),
				new HairstylistBuyInfo( 1018362, 30000, true, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, false, true, ChangeHairHueEntry.HumanRegularEntries } ),
				new HairstylistBuyInfo( 1018363, 500000, false, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, true, false, ChangeHairHueEntry.HumanBrightEntries } ),
				new HairstylistBuyInfo( 1018364, 500000, true, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, false, true, ChangeHairHueEntry.HumanBrightEntries } )
			};

		private static HairstylistBuyInfo[] m_HumanFemaleSellList = new HairstylistBuyInfo[]
			{
				new HairstylistBuyInfo( 1018357, 50000, false, typeof( ChangeHairstyleGump ), new object[]
					{ From, Vendor, Price, false, ChangeHairstyleEntry.HumanFemaleHairEntries } ),
				new HairstylistBuyInfo( 1018359, 50, false, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, true, true, ChangeHairHueEntry.HumanRegularEntries } ),
				new HairstylistBuyInfo( 1018360, 500000, false, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, true, true, ChangeHairHueEntry.HumanBrightEntries } )
		...
		private static HairstylistBuyInfo[] m_ElfMaleSellList = new HairstylistBuyInfo[]
			{
				new HairstylistBuyInfo( 1018357, 50000, false, typeof( ChangeHairstyleGump ), new object[]
					{ From, Vendor, Price, false, ChangeHairstyleEntry.ElfMaleHairEntries } ),
				new HairstylistBuyInfo( 1018359, 50, false, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, true, true, ChangeHairHueEntry.ElfRegularEntries } ),
				new HairstylistBuyInfo( 1018360, 500000, false, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, true, true, ChangeHairHueEntry.ElfBrightEntries } )
			};

		private static HairstylistBuyInfo[] m_ElfFemaleSellList = new HairstylistBuyInfo[]
			{
				new HairstylistBuyInfo( 1018357, 50000, false, typeof( ChangeHairstyleGump ), new object[]
					{ From, Vendor, Price, false, ChangeHairstyleEntry.ElfFemaleHairEntries } ),
				new HairstylistBuyInfo( 1018359, 50, false, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, true, true, ChangeHairHueEntry.ElfRegularEntries } ),
				new HairstylistBuyInfo( 1018360, 500000, false, typeof( ChangeHairHueGump ), new object[]
					{ From, Vendor, Price, true, true, ChangeHairHueEntry.ElfBrightEntries } )
		...
		public override void VendorBuy( Mobile from )
		{
			if ( from.Race == Race.Human )
				from.SendGump( new HairstylistBuyGump( from, this, from.Female ? m_HumanFemaleSellList : m_HumanMaleSellList ) );
			else if ( from.Race == Race.Elf )
				from.SendGump( new HairstylistBuyGump( from, this, from.Female ? m_ElfFemaleSellList : m_ElfMaleSellList ) );
			else if ( from.Race == Race.Gargoyle )
				from.SendLocalizedMessage( 1112474 ); // A hairstylist cannot style your horns!
		}
	...
	{
		public override int TypeID { get { return 0xF3E83; } }
	...
	public class ChangeHairHueEntry
	{
		...
		public static readonly ChangeHairHueEntry[] HumanBrightEntries = new ChangeHairHueEntry[]
			{
		...
		public static readonly ChangeHairHueEntry[] HumanRegularEntries = new ChangeHairHueEntry[]
			{
		...
		public static readonly ChangeHairHueEntry[] ElfBrightEntries = new ChangeHairHueEntry[]
			{
				new ChangeHairHueEntry( "*****", 1356, 5 ),
				new ChangeHairHueEntry( "*****", 1361, 6 ),
				new ChangeHairHueEntry( "*****", 1367, 6 ),
				new ChangeHairHueEntry( "*****", 1373, 6 )
			};

		public static readonly ChangeHairHueEntry[] ElfRegularEntries = new ChangeHairHueEntry[]
			{
				new ChangeHairHueEntry( "*****", 2201, 6 ),
				new ChangeHairHueEntry( "*****", 2207, 6 ),
				new ChangeHairHueEntry( "*****", 2213, 6 ),
				new ChangeHairHueEntry( "*****", 2219, 5 ),
				new ChangeHairHueEntry( "*****", 2101, 6 ),
				new ChangeHairHueEntry( "*****", 2107, 6 ),
				new ChangeHairHueEntry( "*****", 2113, 6 ),
				new ChangeHairHueEntry( "*****", 2119, 6 ),
				new ChangeHairHueEntry( "*****", 2125, 5 ),
				new ChangeHairHueEntry( "*****", 143, 5 ),
				new ChangeHairHueEntry( "*****", 345, 6 ),
				new ChangeHairHueEntry( "*****", 797, 10 )
			};
	}
	...
	public class ChangeHairstyleEntry
	{
		...
		public static readonly ChangeHairstyleEntry[] HumanMaleHairEntries = new ChangeHairstyleEntry[]
			{
				...
				new ChangeHairstyleEntry( 50706, 193 - 260, 140 - 190, 0x2049 ),
				new ChangeHairstyleEntry( 60901, 315 - 383, 150 - 190, 0x2048 ),
				new ChangeHairstyleEntry( 0, 0, 0, 0 )
			};

		public static readonly ChangeHairstyleEntry[] HumanFemaleHairEntries = new ChangeHairstyleEntry[]
			{
				new ChangeHairstyleEntry( 50700,  70 - 137,  20 -  60, 0x203B ),
				new ChangeHairstyleEntry( 60710, 193 - 260,  18 -  60, 0x2045 ),
				new ChangeHairstyleEntry( 50703, 316 - 383,  25 -  60, 0x2044 ),
				...
				new ChangeHairstyleEntry( 60702,  70 - 137, 140 - 190, 0x203D ),
				new ChangeHairstyleEntry( 50706, 193 - 260, 140 - 190, 0x2049 ),
				new ChangeHairstyleEntry( 60712, 317 - 383, 145 - 190, 0x2046 ),
				new ChangeHairstyleEntry( 0, 0, 0, 0 )
			};
		...
		public static readonly ChangeHairstyleEntry[] ElfMaleHairEntries = new ChangeHairstyleEntry[]
			{
				new ChangeHairstyleEntry( 1785,  50 - 137,   5 -  60, 0x2FC0 ),
				new ChangeHairstyleEntry( 1790, 173 - 260,   5 -  60, 0x2FCE ),
				new ChangeHairstyleEntry( 1784, 295 - 383,   5 -  60, 0x2FBF ),
				new ChangeHairstyleEntry( 1786,  50 - 137,  70 - 125, 0x2FC1 ),
				new ChangeHairstyleEntry( 1791, 173 - 260,  65 - 125, 0x2FCF ),
				new ChangeHairstyleEntry( 1789, 295 - 383,  65 - 125, 0x2FCD ),
				new ChangeHairstyleEntry( 1787,  50 - 137, 135 - 190, 0x2FC2 ),
				new ChangeHairstyleEntry( 1793, 173 - 260, 140 - 190, 0x2FD1 ),
				new ChangeHairstyleEntry( 0, 0, 0, 0 )
			};

		public static readonly ChangeHairstyleEntry[] ElfFemaleHairEntries = new ChangeHairstyleEntry[]
			{
				new ChangeHairstyleEntry( 1775,  50 - 137,   5 -  60, 0x2FC0 ),
				new ChangeHairstyleEntry( 1780, 173 - 260,   5 -  60, 0x2FCE ),
				new ChangeHairstyleEntry( 1778, 295 - 383,   5 -  60, 0x2FBF ),
				new ChangeHairstyleEntry( 1776,  50 - 137,  70 - 125, 0x2FC1 ),
				new ChangeHairstyleEntry( 1781, 173 - 260,  65 - 125, 0x2FCF ),
				new ChangeHairstyleEntry( 1782, 295 - 383,  65 - 125, 0x2FCD ),
				new ChangeHairstyleEntry( 1777,  50 - 137, 135 - 190, 0x2FC2 ),
				new ChangeHairstyleEntry( 1783, 173 - 260, 140 - 190, 0x2FD1 ),
				new ChangeHairstyleEntry( 0, 0, 0, 0 )
			};
	}
