...
namespace Server.Mobiles
{
	...
	public class VendorBackpack : Backpack
	{
		...
		public override void GetChildNameProperties( ObjectPropertyList list, Item item )
		{
			...
			{
				list.Add( 1043304, vi.Price.ToString( "N0" ) ); // Price: ~1_COST~
			}
		}
	...
	public class PlayerVendor : Mobile
	{
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public int BankAccount { get { return m_BankAccount; } set { m_BankAccount = value; } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int HoldGold { get { return m_HoldGold; } set { m_HoldGold = value; } }
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public DateTime NextPayTime { get { return m_NextPayTime; } }

		public PlayerVendorPlaceholder Placeholder { get { return m_Placeholder; } set { m_Placeholder = value; } }
		...
		public override bool OnDragDrop( Mobile from, Item item )
		{
			...
			{
				if ( item is RepairContract )
				{
					Say( 1047015 ); // I'm sorry, I cannot accept a contract as merchandise.
		...
		private void OnItemGiven( Mobile from, Item item )
		{
			...
			if ( vi != null )
			{
				...
				from.Prompt = new VendorPricePrompt( this, vi, name );
			}
		}
		...
		public void OpenBackpack( Mobile from )
		{
			if ( this.Backpack != null )
			{
				...
				if ( House != null && House.Public && !House.IsFriend( from ) && !IsOwner( from ) )
				{
					House.Visits++;
				}
		...
		public void Dismiss( Mobile from )
		{
			...
			if ( HoldGold > 0 )
			{
				SayTo( from, 1072059 ); // You cannot dismiss me while I am holding your gold.
				return;
			}
		...
		private class DismissGump : Gump
		{
			public override int TypeID { get { return 0x2371; } }

			private PlayerVendor m_Vendor;

			public DismissGump( PlayerVendor vendor )
				: base( 50, 50 )
			{
				m_Vendor = vendor;
				...
				AddBackground( 0, 0, 250, 120, 9250 );

				AddHtmlLocalized( 15, 15, 220, 60, 1071243, 0x0, true, false ); // Do you really wish to dismiss this vendor?

				AddButton( 170, 80, 0xF7, 0xF8, 1, GumpButtonType.Reply, 0 );
