...
namespace Server.Mobiles
{
	...
	public class RentedVendor : PlayerVendor
	{
		...
		public VendorRentalDuration RentalDuration { get { return m_RentalDuration; } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int RentalPrice { get { return m_RentalPrice; } set { m_RentalPrice = value; } }

		[CommandProperty( AccessLevel.GameMaster )]
		public bool LandlordRenew { get { return m_LandlordRenew; } set { m_LandlordRenew = value; } }

		[CommandProperty( AccessLevel.GameMaster )]
		public bool RenterRenew { get { return m_RenterRenew; } set { m_RenterRenew = value; } }

		[CommandProperty( AccessLevel.GameMaster )]
		public bool Renew { get { return LandlordRenew && RenterRenew && House != null && House.DecayType != DecayType.Condemned; } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int RenewalPrice { get { return m_RenewalPrice; } set { m_RenewalPrice = value; } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int RentalGold { get { return m_RentalGold; } set { m_RentalGold = value; } }

		[CommandProperty( AccessLevel.GameMaster )]
		public DateTime RentalExpireTime { get { return m_RentalExpireTime; } }
		...
		private class RefundOfferPrompt : Prompt
		{
			...
			public override void OnResponse( Mobile from, string text )
			{
				...
				int amount;
				try { amount = Convert.ToInt32( text ); }
				catch { amount = -1; }
				...
				if ( amount < 0 )
				{
					// You did not enter a valid amount.  Offer canceled.
					from.SendLocalizedMessage( 1062506 );
				}
				else if ( Banker.GetBalance( from ) < amount )
				{
					// You do not have that much money in your bank account.
					from.SendLocalizedMessage( 1062507 );
				}
				else if ( owner.Map != m_Vendor.Map || !owner.InRange( m_Vendor, 5 ) )
				{
					...
					from.SendLocalizedMessage( 1062505 );
				}
				else
				{
					// Please wait while the renter considers your offer.
					from.SendLocalizedMessage( 1062504 );
