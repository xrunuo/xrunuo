...
{
	public class OldSeekerOfAdventure : BaseEscortable
	{
		private static string[] m_Dungeons = new string[] { "Covetous", "Deceit", "Despise", "Destard", "Hythloth", "Shame", "Wrong" };
		...
		public OldSeekerOfAdventure( Serial serial )
			: base( serial )
		{
		}
