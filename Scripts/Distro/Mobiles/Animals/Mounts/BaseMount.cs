...
namespace Server.Mobiles
{
	public abstract class BaseMount : BaseCreature, IMount
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.LocalOverheadMessage( Server.Network.MessageType.Regular, 0x3B2, 1112281 ); // Gargoyles are unable to ride animals.
				return;
			}
		...
		public static void SetMountPrevention( Mobile mob, BlockMountType type, TimeSpan duration )
		{
			...
			else
			{
				...
				BuffInfo.AddBuff( mob, new BuffInfo( BuffIcon.DismountPrevention, 1075635, duration, mob ) );
			}
		}
