...
namespace Server.Mobiles
{
	public class EtherealMount : Item, IMount, IMountItem, Engines.VeteranRewards.IRewardItem
	{
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1113818, "{0}", SolidHue ? "Normal" : "Transparent" ); // Mount Hue: ~1_val~
		}
	...
	{
		public override int LabelNumber { get { return 1113916; } } // Ethereal Hiryu Statuette
...
namespace Server.Items
{
	...
	{
		public override int LabelNumber { get { return 1113908; } } // Ethereal Reptalon Statuette
